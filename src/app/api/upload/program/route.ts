...
export async function POST(request: NextRequest) {
  try {
    ...
    const hasCreatePermission = await hasAnyPermission(user.id, [
      "program.kurikulum.create",
      "program.sarpras.create",
      "program.siswa.create",
      "program.humas.create",
    ]);
...
export async function DELETE(request: NextRequest) {
  try {
    ...
    const hasDeletePermission = await hasAnyPermission(user.id, [
      "program.kurikulum.delete",
      "program.sarpras.delete",
      "program.siswa.delete",
      "program.humas.delete",
    ]);
